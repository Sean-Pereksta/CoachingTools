...
`;
  ...
  function initializeUi() {
    ...
    ['psCompletenessMode','psCompletenessThreshold'].forEach(id=>doc.getElementById(id).addEventListener(id==='psCompletenessThreshold'?'input':'change',()=>{if(state.diagnostics)renderResults(state.currentRows,state.diagnostics);}));
